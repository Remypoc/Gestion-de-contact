...
<html>
	<head>
		...
		<title><bean:message key="phonenumber.search.page.title"/></title>
	</head>
	<body>
		<h1><bean:message key="phonenumber.search.page.title" /></h1>
		<html:errors/>
			<html:form action="/SearchPhoneNumber">
				<table>
					<tr>
					...
					<tr>
					<td>
						<input type="submit" class="btn btn-primary" value=" <bean:message key="form.search.validate" />" />
