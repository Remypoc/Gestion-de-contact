...
<html>
	<head>
		...
		<title><bean:message key="address.creation.page.title"/></title>
	</head>
	<body>
		<h1><bean:message key="address.creation.page.title" /></h1>
		<html:errors/>
			<html:form action="/AddAddress">
				<table>
					...
					<td>
						...
						<input type="reset" class="btn btn-primary" value="<bean:message key="form.creation.cancel" />" />
					</td>
					</tr>
				</table>
			</html:form>
