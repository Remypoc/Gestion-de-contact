...
import actionForm.UpdateAddressValidationForm;
...
public class UpdateAddressAction extends Action {
	...
	public ActionForward execute(final ActionMapping pMapping, ActionForm pForm, 
		...
		final UpdateAddressValidationForm lForm = (UpdateAddressValidationForm) pForm;
		...
		final Object lError = lDAOContact.updateAddress(address);
